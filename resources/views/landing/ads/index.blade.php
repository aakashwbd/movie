                ...
                <div class="col-lg-4 col-sm-12 order-sm-2 order-lg-1 mb-3">
                    <div class="row">
                        <div class="col-lg-10 col-12 offset-lg-1">
                            <button class="btn btn-primary mb-3" id="advertisementButton">Place your advertisement
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('api/place/store')}}" id="placeForm">
                        <div class="text-center">
                            ...
                            <div class="d-flex align-items-center justify-content-center my-2">
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" value="1 month" name="duration"
                                           id="month">
                                ...
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" value="1 week" name="duration"
                                           id="week">
                                ...
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" value="24 hour" name="duration"
                                           id="hour">
                        ...
                        <div class="form-group mb-3">
                            <label for="address" class="form-label address_label" id="address_label">Location</label>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="description" id="description" placeholder="message"
                        ...
                        <div>
                            ...
                            <img style="width: 100%; height: 200px;" class="d-none my-3" id="placeImagePreview" src=""
                                 alt="">
                        ...
                        <button type="button" data-bs-dismiss="modal" class="btn btn-outline-secondary my-3">Cancel
                        </button>
                    </form>
