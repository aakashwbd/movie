                ...
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <form action="{{url('/api/auth/register')}}" id="inscriptionForm">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12 mb-4">
                                <input type="text" maxlength="13" name="username" id="username" class="form-control" placeholder="Username (Max. 13 characters)">
                            ...
                            <div class="col-lg-12 col-sm-12 mb-4">
                                <div class="d-flex align-items-center">
                                    <img id="inscriptionPreviewImgURL" class="avatar-sm d-none me-3 border" src="" alt="">
                                    <input type="hidden" name="image" id="inscriptionImgURL" >
                                    <input type="file" id="file-uploader" onchange="uploader(event,'','', 'inscriptionImgURL','inscriptionPreviewImgURL')" hidden name="image"/>
                                    <label for="file-uploader"
                                           class="text-white-50 border p-2 d-flex align-items-center cursor-pointer">
                                ...
                                <div class="form-check text-white-50">
                                    ...
                                    <label class="form-check-label text-white" for="termsCheck">
                                        I have read and accept the <a href=""
                                                       class="text-white text-decoration-underline ">terms and policies</a>
                                    </label>
                                </div>
                            </div>
