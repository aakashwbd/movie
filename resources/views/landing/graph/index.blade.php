...
{{--                </li>--}}
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">pr</button>
                </li>

                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Testimony</button>
                </li>
            </ul>
...
@push('custom-js')
    <script>
        ...
        $(document).ready(function (){
            ...
            $.ajax({
                url: window.origin + '/api/testimony/'+user.id,
                type: 'get',
